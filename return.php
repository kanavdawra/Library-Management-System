    ...
    <?php if ( $chk == 1 ) : ?>
      ...
      <form method="post" action="<?=$show?>">
          ...
          <input type="text" name="uname" placeholder="USERNAME" class="input-txt" ><br/>
            ...
            <input type="submit" name="return" value="Return" class="btn btn--left" formaction="<?=$ret?>">
            <input type="submit" name="details" value="Details" class="btn btn--right" formaction="<?=$show?>" >
