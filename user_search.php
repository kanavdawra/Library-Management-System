...
<section><div> 
    	 	...
    	 	<?php
		echo "<form method='post' action='user_search.php' >"; 
...
if ($result->num_rows > 0) {
	...
	echo "<strong>PUBLISHER : </strong>";
	 ...
	 echo "<br>";
	echo "<center><button onclick=\"location.href='user_search.php'\" class=\"button\">SEARCH</button>";
	
	echo "<button onclick=\"location.href='user_books.php'\" class=\"button\" formaction=\"user_books.php\">FULL LIST</button>";
	 echo "</form>";
?>
