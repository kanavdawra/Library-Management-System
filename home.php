...
$sql = "SELECT * FROM issue WHERE USERNAME='$userid'";
...
$show = "SELECT * FROM books where ACCESSION='$book1' OR ACCESSION='$book2' ";
$result1 = $con->query($show);

if ($result1->num_rows > 0) {
     echo "<table><thead><tr><th>ID</th><th>NAME</th><th>AUTHOR</th><th>PUBLISHER</th><th>EDITION</th><th>ACCESSION</th></tr></thead>";
     // output data of each row
     while($row = $result1->fetch_assoc()) {
		
     
         echo "<tr><td><strong>" . $row["ID"]. "</strong></td><td>" . $row["NAME"]. "</td><td>" . $row["AUTHOR"]. "</td><td>" . $row["PUBLISHER"]. "</td><td>" . $row["EDITION"]. "</td><td>" . $row["ACCESSION"]. "</td></tr>";
